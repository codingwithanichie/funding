...
const Navbar = () => {
  ...
  return (
    <div className='flex md:flex-row flex-col-reverse justify-between mb-[35px] gap-6'>N
...
{/* CONNECT BUTTON AND CREATE CAMPAIGN BUTTON */}
      <div className='sm:flex hidden flex-row justify-end gap-4'>
        <CustomButton btntype='button' title={address ? 'Create a campaign' : 'Connect'} 
        styles={address ? 'bg-[#1dc071]' : 'bg-[#8c6dfd]'} handleClick={() => {
          if(address) {
...
{/* CREATE A CAMPAIGN AND CONNECT BUTTON */}
